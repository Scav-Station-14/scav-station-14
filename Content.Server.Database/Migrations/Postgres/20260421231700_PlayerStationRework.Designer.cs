...
namespace Content.Server.Database.Migrations.Postgres
{
    ...
    [Migration("20260421231700_PlayerStationRework")]
    partial class PlayerStationRework
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProfileShip", b =>
                {
                    ...
                    b.Property<int>("ShipsId")
                        .HasColumnType("integer")
                        .HasColumnName("ships_id");

                    b.HasKey("ProfilesId", "ShipsId")
                        .HasName("PK_profile_ship");

                    b.HasIndex("ShipsId")
                        .HasDatabaseName("IX_profile_ship_ships_id");
            ...
            modelBuilder.Entity("ProfileShip", b =>
                {
                    ...
                    b.HasOne("Content.Server.Database.Ship", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_profile_ship_ship_ships_id");
                });
