...
/// </summary>
public sealed class ScavAdventureRuleSystem : GameRuleSystem<ScavAdventureRuleComponent>
{
    ...
    private void GenerateStations(MapId mapUid, PlayerStation playerStation, string currentPreset, out EntityUid? stationUid, out int startingBankBalance)
    {
        ...
        var offset = _poi.GetRandomPOICoord(proto.MinimumDistance, proto.MaximumDistance, proto.MinimumClearance);
