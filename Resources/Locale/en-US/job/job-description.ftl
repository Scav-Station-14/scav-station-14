...
job-description-cargotech = Deal with requisitions and deliveries, organize inventory, and make sure away missions have all their paperwork in order.
...
job-description-qm = Manage the supplies of the station & the cargo department, organize away missions working, make sure all orders are fulfilled, and keep the money flowing.
